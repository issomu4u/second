...
using SellerVendor.Areas.Seller.AmazonAPI.settlement.Mock;
...
namespace SellerVendor.Areas.Seller.AmazonModel.settlementModel
{
        ...
        */
        public static void Main(string [] args)
        {
            ...
            ***********************************************************************/
            ...
            const string applicationName = "MarketplaceWebServiceSample";
            ...
            const string merchantId = "ALX5VZP4KM90V";
            const string marketplaceId = "A21TJRUUN4KGV";
            ...
            //MarketplaceWebService service2 = new MarketplaceWebServiceClient(accessKeyId, secretAccessKey, config);
 ...
 ***********************************************************************/
            {
                ...
                DateTime DtStart;
                DateTime DtEnd;
                DtStart = DateTime.Parse("2017-12-01 23:59:59");
                DtEnd = DateTime.Parse("2017-12-08 23:59:59");
                ...
                //request.WithReportRequestIdList = "86586017542";
                // @TODO: set additional request parameters here
                List<string> InvokeGetReportList = new List<string>();
                //GetReportListSample obj = new GetReportListSample();
                ...
                foreach (var item in InvokeGetReportList)
                {
                    ...
                    request1.Merchant = merchantId;
                   
                    string responseXml = "";

                    request1.ReportId = item;//"8591233350017507"; // "9064510021017542";  

                     request1.Report = File.Open("D://" + item + ".xml", FileMode.OpenOrCreate, FileAccess.ReadWrite);

                    //string strFolderPath = HttpContext.Current.Server.MapPath("~/settlementfile-" + item + ".xml", FileMode.OpenOrCreate, FileAccess.ReadWrite);


                    //string strFolderPath = Server.MapPath("~/settlementfile");
                    /* if (!Directory.Exists(strFolderPath))
                     {
                         Directory.CreateDirectory(strFolderPath);
                     }*/
                    //GetReportSample.InvokeGetReport(service, request1);
                 ...
                 //GetReportListResponse = service.GetReportRequestList()
                //obj = GetReportListSample.InvokeGetReportList;
            ...
            
            {
                ...
                //request.ReportId = "8591233350017507"; // "9064510021017542";               
                //request.Report = File.Open("report.xml", FileMode.OpenOrCreate, FileAccess.ReadWrite );
                // GetReportSample.InvokeGetReport(service, request);

                // GetReportResponse resp =  service.GetReport(request);
                // ResponseHeaderMetadata rhmd = resp.ResponseHeaderMetadata;
