angular.module('MyApp2').controller('SellerVendorController', function ($scope, SellerVendorServices) {
    ...
    fac.SaveSelleVendor = function (vendor_name, mobile, telephone, email, address, contact_person, country,
        ...
        var defer = $q.defer();
        $http.post("/Home/SaveSellerVendorDetails", formData,
            {
    ...
    fac.GetSellerVendorList = function () {
        return $http.get('/Home/GetSellerVendor');
    }
    ...
    fac.UpdateSellerVendor = function (SellersVendorDetails) {
        ...
        var response = $http({
            method: "post",
            url: "/Home/UpdateSellerVendorDetails",
